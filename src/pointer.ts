...
/** Options passed in to the Pointer constructor. */
...
class Pointer {
  ...
  constructor(readonly options: PointerOptions) {
  ...
  /** Destroy this Pointer instance and close any sockets. */
  dispose() {
